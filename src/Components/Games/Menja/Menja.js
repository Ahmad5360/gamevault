    ...
    <div className="body">
      ...
      <div className="menus">
        <div className="menu menu--main">
          <h1>MENJA</h1>
          <button type="button" className="play-normal-btn" id="button">
            PLAY GAME
          </button>
          <button type="button" className="play-casual-btn" id="button">
            CASUAL MODE
          </button>
          {/* <div className="credits">
            Project Created By <a href="main.html">Neha Nadeem</a>
          </div>
          <div className="credits">An 8kB game by <a href="https://cmiller.tech">Caleb Miller</a></div> */}
        </div>
        <div className="menu menu--pause">
          <h1>Paused</h1>
          <button type="button" className="resume-btn" id="button">
            RESUME GAME
          </button>
          <button type="button" className="menu-btn--pause" id="button">
            MAIN MENU
          </button>
        </div>
        <div className="menu menu--score">
          ...
          <button type="button" className="play-again-btn" id="button">
            PLAY AGAIN
          </button>
          <button type="button" className="menu-btn--score" id="button">
            MAIN MENU
          </button>
        </div>
      </div>
